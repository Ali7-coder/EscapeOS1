...
The next public IPA after **0.1.4** is **0.1.5 or higher**. Never replace `v0.1.0` or `v0.1.1` once they have downloads. `v0.1.4` was pulled once (password Extract hidden on iOS 26) and republished the same day with that fix; do not recut it again.
