...
The next public IPA after **0.1.4** is **0.1.5 or higher**. Never replace `v0.1.0` or `v0.1.1` once they have downloads. `v0.1.4` was pulled twice the same day (Extract hidden on iOS 26; pairing Files picker too narrow) and republished with those fixes; do not recut it again.
