...
- Path-scoped Data-container browse, edit, share, backup zip + restore. Copy/Cut/Paste files across folders (and apps); Copy Path, Copy Bundle ID, and Copy SHA-256.
